...
"p2":["Knows the material", "Learned A LOT", "Very keen"],
"p3" : ["Easy A","Lenient grader", " Guaranteed A"],
"p4" : ["Chill course", "Light workload", "Laid back "],

"n1" : ["BORING", "Material not intereseting", "Boring"],
...
"b2" : ["Didn't learn Anything","Useless class","LEARNED NOTHING"],
"b3" : ["HORRIBLE PROFESSOR","Doesn't care at all","AWFUL PROFESSOR"],
